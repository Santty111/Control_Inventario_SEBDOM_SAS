...
namespace Control_Inventario_SEBDOM_SAS.Controllers
{
    public class InventariosController : Controller
    {
        ...
        public InventariosController(Control_Inventario_SEBDOM_SASContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,WithCheese,Precio")] Inventario inventario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,WithCheese,Precio")] Inventario inventario)
        {
            if (id != inventario.Id)
            {
                return NotFound();
